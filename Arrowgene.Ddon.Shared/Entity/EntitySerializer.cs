...
namespace Arrowgene.Ddon.Shared.Entity
{
    public abstract class EntitySerializer
    {
        ...
        static EntitySerializer()
        {
            ...
            Create(new C2SPawnExpeditionCancelSallyReq.Serializer());
            Create(new C2SPawnExpeditionChangeGoldenSallyReq.Serializer());
            Create(new C2SPawnExpeditionChargeSallyCountReq.Serializer());
            Create(new C2SPawnExpeditionGetMySallyInfoReq.Serializer());
            Create(new C2SPawnExpeditionGetRewardDropItemListReq.Serializer());
            Create(new C2SPawnExpeditionGetRewardDropItemReq.Serializer());
            Create(new C2SPawnExpeditionGetRewardDropReq.Serializer());
            Create(new C2SPawnExpeditionGetSallyInfoReq.Serializer());
            Create(new C2SPawnExpeditionGetSallyRewardReq.Serializer());
            Create(new C2SPawnExpeditionSallyReq.Serializer());
            ...
            Create(new S2CSwitchStorageNtc.Serializer());
            ...
            Create(new S2CPawnExpeditionCancelSallyRes.Serializer());
            Create(new S2CPawnExpeditionChangeGoldenSallyRes.Serializer());
            Create(new S2CPawnExpeditionChargeSallyCountRes.Serializer());
            Create(new S2CPawnExpeditionGetMySallyInfoRes.Serializer());
            Create(new S2CPawnExpeditionGetRewardDropItemListRes.Serializer());
            Create(new S2CPawnExpeditionGetRewardDropItemRes.Serializer());
            Create(new S2CPawnExpeditionGetRewardDropRes.Serializer());
            Create(new S2CPawnExpeditionGetSallyInfoRes.Serializer());
            Create(new S2CPawnExpeditionGetSallyRewardRes.Serializer());
            Create(new S2CPawnExpeditionSallyRes.Serializer());
            ...
            Create(new S2CQuestBoardReloadNtc.Serializer());
